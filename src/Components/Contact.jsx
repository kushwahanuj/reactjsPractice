                ...
                <div className="container">
                    <div className="row justify-content-md-center">
                        <div className="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
                            <h2 className="mb-4 display-5 text-center">{contacttitle}</h2>
                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className="row gy-4 gy-xl-5 p-4 p-xl-5">
                                        <div className="col-12">
                                            ...
                                            <input type="text" className="form-control" id="fullname" name="fullname" value={fullname} required onChange={(e) => setFullname(e.target.value)} />
                                        </div>
                                        ...
                                        <div className="col-12">
                                            ...
                                            <textarea className="form-control" id="message" name="message" rows="3" required value={message} onChange={(e) => setMessage(e.target.value)}></textarea>
                                        </div>
                                        <div className="col-12">
